...
import { healthInsuranceScenario } from "@/app/agentConfigs/healthInsuranceAgent";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (finalAgentConfig !== 'healthInsurance') {
  ...
  const connectToRealtime = async () => {
    ...
    if (sdkScenarioMap[agentSetKey]) {
      ...
      try {
        ...
        const guardrails = [createModerationGuardrail('Health Insurance Calculator')];
    ...
    <div className="text-base flex flex-col h-screen bg-gray-100 text-gray-800 relative">
      <div className="p-5 text-lg font-semibold flex justify-between items-center">
        ...
        >
          ...
          <div>
            Health Insurance Calculator <span className="text-gray-500">Agent</span>
          </div>
        </div>
